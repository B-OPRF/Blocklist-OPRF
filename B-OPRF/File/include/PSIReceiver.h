...
class PSIReceiver
{
    ...
    void test_and_commit(vec_ZZ_p eval_pts, vec_ZZ_p *inSet, ZZ_pX key_poly_one, ZZ_pX key_poly_two)
    {
       ...
       for(int i = 0 ; i < setSize; i++)
       {
        ...
        auto end_time = high_resolution_clock::now();
        auto duration = duration_cast<milliseconds>(end_time - start_time);
        std::cout << "Receiver PSI time: " << duration.count() << "ms" << endl; 
        /* 
        We will get the elements for the commitment
        */
        ...
        */
        ...
        cout << "Policy Checker OT Cost: " << io->counter << "bytes" << endl;
        ...
        end_time = high_resolution_clock::now();
        duration = duration_cast<milliseconds>(end_time - start_time);
        std::cout << "Receiver: Commit time (2): " << duration.count() << "ms" << endl; 
